 ...
 * @method static void processReaction(\BootDesk\ChatSDK\Core\Contracts\Adapter $adapter, string $threadId, string $emoji, string $messageId, \BootDesk\ChatSDK\Core\Author $user, mixed $raw = null)
